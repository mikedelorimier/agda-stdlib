...
--
-- Properties of TODO-what? related to Any
------------------------------------------------------------------------
...
module Data.Tree.AVL.Indexed.Relation.Unary.Any.Properties.Range
...
open import Relation.Unary.Properties using (ℓ-∩-congˡ; Universal→≐)
...
∈-ex-ex? lo hi k = (lo IsSTO⁺.<? [ k ]) ×? ([ k ] IsSTO⁺.<? hi)
...
∈-inc-ex? lo hi k = lo DTO⁺.≤? [ k ] ×? ([ k ] IsSTO⁺.<? hi)
